    ...
    def get_indicators_dataframe(self):
        ...
        for indicator in grouped:
            ...
            rows.append({
                ...
                'Data show map': self.get_metadata_field_value_link(store['national_geographical_coverage']['values'][store['national_geographical_coverage']['indicators'][indicator]]) if indicator in store['national_geographical_coverage']['indicators'] else '',
                'National geographical coverage': self.get_metadata_field_value_link(store['data_show_map']['values'][store['data_show_map']['indicators'][indicator]]) if indicator in store['data_show_map']['indicators'] else '',
