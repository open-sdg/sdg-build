...
setup(name='sdg',
      ...
      python_requires='>=3.5',
      install_requires=['pyyaml', 'gitpython', 'numpy', 'pandas', 'yamlmd', 'jsonschema', 'requests', 'humanize', 'unicode-slugify', 'sdmx1', 'frictionless', 'csvw', 'mammoth', 'pyquery', 'pyjstat', 'Jinaj2'],
      dependency_links=[
