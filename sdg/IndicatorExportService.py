...
class IndicatorExportService:
    ...
    def __get_all_indicator_csv_files(self):
        ...
        for file_name in all_data_file_names:
            if self.__file_is_csv(file_name) and self.__file_has_complete_statistical_data(file_name):
    ...
    def __file_has_complete_statistical_data(self, file_name):
        ...
        complete = self.__indicators[indicator_id].is_complete()
        statistical = self.__indicators[indicator_id].is_statistical()
        return complete and statistical
